...
function Nav() {
    return (
        <nav className="bg-white fixed w-full flex h-16 border-b border-gray-400 top-0 left-0 p-4 z-50">
...
const SearchBox = ({ currentRefinement, isSearchStalled, refine }) => (
    <div className="w-full lg:px-6 xl:w-3/4 xl:px-12">
        <form className="bg-gray-200 focus:bg-white hover:bg-white hover:shadow-md px-2 py-2 w-448 w-full flex items-center rounded-md">
            ...
            <input
                className="bg-transparent w-full placeholder-gray-600 text-gray-600 focus:bg-white "
                placeholder="Search for restaurants, meals and deals..."
                type="search"
